...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">    الفواتير المدفوعة جزئيا </h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
						</div>
					</div>
				...
				<div class="modal-content modal-content-demo">
					...
					{{method_field('delete')}}
						...
						<h6 class="modal-title">  هل انت متاكد من حذف الفاتورة ؟</h6>
							<input class="form-control" value="" id="invoice_id" name="invoice_id" type="text" autofocus="">
						</div>
