                    ...
                    <form action="{{ url('invoices/update') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select id="" name="product" class="form-control">
                                <option value="{{$invoices->product}}" selected disabled>{{$invoices->product}}</option>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="" value="{{$invoices->Amount_collection}}" name="Amount_collection"
