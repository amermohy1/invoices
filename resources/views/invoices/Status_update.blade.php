...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">اضافة فاتورة</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"></span>
						</div>
					</div>
                    ...
                    <form action="{{ route('Status_update',['id' => $invoices->id]) }}" method="post" 
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" readonly class="form-control" id="" name="invoice_number"
                                 title="يرجي ادخال رقم الفاتورة" value="{{$invoices->invoice_number}}" >
                            </div>

                            <div class="col">
                                <label>تاريخ الفاتورة</label>
                                <input readonly class="form-control fc-datepicker" 
                                value="{{$invoices->invoice_date}}" name="invoice_date" placeholder="YYYY-MM-DD"
                                    type="text"  required>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" readonly class="form-control form-control-lg" value="{{$invoices->Amount_Commission}}" id="Amount_Commission"
                                    name="Amount_Commission" title="يرجي ادخال مبلغ العمولة " required>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">الخصم</label>
                                <input type="text" readonly class="form-control form-control-lg" value="{{$invoices->discount}}" id="discount" name="discount"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" readonly value="{{$invoices->note}}" id="exampleTextarea" name="note" rows="3">{{$invoices->note}}</textarea>
                            </div>
                            </div><br>
                            <div class="row">
                              <div class="col">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary"> تحديت حالة الدفع </button>
                        </div>
